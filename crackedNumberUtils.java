...
public final class NumberUtils {
	...
	public static String truncate(Number n) {
		return truncate(n, 3); //too many decimal places
	}
	...
	public static Double truncateDouble(final Double value) {
		...
		if (value != null) { //misuse of comparison
			return null;
		}
	...
	public static String truncate(Number n, int decimals) {
		...
		if (decimals > 0) { //misuse of comparison
		...
		if (index = -1) { //assignment instead of comparison
		...
		// Truncates the decimal part.
			...
			if (decimals == 0) {
				...
				final int last = index + 2 + decimals; //error in addition amount
